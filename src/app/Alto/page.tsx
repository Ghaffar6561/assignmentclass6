...
export default function Alto(){
    return(
        ...
        <div className="bg-blue-100">
            <h1 className="flex align-middle justify-center text-4xl"><b><u>Suzuki Alto 2024 Price in Pakistan,Image, Reviews & Specs</u></b></h1>
            <br />

            <div className=" flex justify-center align-middle w-15">
            <img  src="suzukialto2.png" alt="Toyota Alto Image" className="w-1/4 mb-10 mt-10" /></div>
            ...
            <div>
                ...
                <h1 className=" flex mt-3 mb-5 justify-center font-semibold text-green-600">PKR 20,00,000</h1>
             </div>
