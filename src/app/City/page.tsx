...
export default function City(){
    return(
        ...
        <div className="bg-blue-100">
            <h1 className="flex align-middle justify-center text-4xl"><b><u>Honda City 2024 Price in Pakistan,Image, Reviews & Specs</u></b></h1>
            <br />
            ...
            <div>
                ...
                <h1 className=" flex mt-3 mb-5 justify-center font-semibold text-green-600">PKR 48,50,000</h1>
             </div>
             
             
             <div className="flex justify-center">
                <button className="flex justify-center border px-2 py-2 border-blue-800 align-middle rounded-md bg-blue-900 text-white"><a href="./Forms">Make Payment</a></button>
