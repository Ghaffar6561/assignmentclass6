...
export default function Corolla(){
    return(
        ...
        <div className="bg-blue-100">
            <h1 className="flex align-middle justify-center text-4xl"><b><u>Toyota Corolla 2024 Price in Pakistan,Image, Reviews & Specs</u></b></h1>
            <br />

            <div className=" flex justify-center align-middle w-15">
            <img  src="corollahybrids.jpg" alt="Toyota Corolla Image" className="w-1/4 mb-10 mt-10" /></div>
            ...
            <div>
                ...
                <h1 className=" flex mt-3 mb-5 justify-center font-semibold text-green-600">PKR 50,00,000</h1>
             </div>
             
             
             <div className="flex justify-center">
                <button className="flex justify-center border mb-2 px-2 py-2 border-blue-800 align-middle rounded-md bg-blue-900 text-white"><a href="./Forms">Make Payment</a></button>
